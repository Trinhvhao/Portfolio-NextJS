          ...
          >
            ...
            <div className="flex items-center justify-between border-b border-white/5 bg-[#141414] px-4 py-3">
              <div className="flex items-center gap-3 flex-1">
                ...
                <Command.Input 
                  placeholder="Try 'nextjs' or 'react'..." 
              ...
              <div className="flex items-center gap-2 border-l border-white/10 pl-3 ml-2 flex-shrink-0">
                <button className="rounded-full px-3 py-1 text-sm font-medium text-white hover:bg-white/10 border border-white/10 transition-colors">
                  Connect
                </button>
            ...
            <Command.List className="overflow-y-auto overflow-x-hidden p-3 style-scroll">
              ...
              <div className="mb-4">
                <div className="flex items-center justify-between px-2 mb-2">
                  <h3 className="text-[11px] font-semibold tracking-wider text-zinc-500 uppercase">Recent</h3>
                  <button className="text-[11px] font-semibold tracking-wider text-zinc-500 uppercase hover:text-zinc-300">Clear</button>
                </div>
                
                <div className="flex items-center gap-2 overflow-x-auto pb-3 px-2 no-scrollbar">
                  {[
                    { label: "Book a call", icon: CalendarDays, href: "/book" },
                    { label: "Resume", icon: FileText, href: "/about" },
                    { label: "Bucket List", icon: ListChecks, href: "/bucket-list" },
                    { label: "Skills", icon: Briefcase, href: "/projects" },
                    { label: "Attribution", icon: Medal, href: "/attribution" }
                  ].map((item, i) => (
              ...
              <div className="px-2 mb-2">
                <h3 className="text-[11px] font-semibold tracking-wider text-zinc-500 uppercase">Pages</h3>
              </div>
              ...
              <Command.Group className="mb-4">
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-1 px-1">
                  {[
                     ...
                     { label: "Guestbook", icon: BookHeart, href: "/guestbook" },
                     { label: "Bucket List", icon: ListChecks, href: "/bucket-list" },
                     { label: "Uses", icon: Laptop, href: "/uses" },
                     { label: "Attribution", icon: Medal, href: "/attribution" },
              ...
              <div className="px-2 mb-2 mt-4">
                <h3 className="text-[11px] font-semibold tracking-wider text-zinc-500 uppercase">Connect</h3>
              </div>
