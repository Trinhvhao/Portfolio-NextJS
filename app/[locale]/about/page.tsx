  ...
  return (
    <>
      ...
      <main className="container relative flex min-h-screen flex-col mask-[linear-gradient(to_bottom,transparent,black_10rem,black_calc(100%-10rem),transparent)] max-sm:px-1">
        <div className="grid flex-1 grid-cols-[12px_minmax(0,1fr)_12px] lg:grid-cols-[32px_minmax(0,1fr)_32px]">
          <div
            aria-hidden="true"
          ...
          <div className="relative col-span-1 flex min-w-0 w-full flex-col justify-center gap-16 py-16 pt-36 [&_.route-typewriter]:max-w-full [&_.route-typewriter]:!whitespace-normal">
            <AboutIntroSection />
